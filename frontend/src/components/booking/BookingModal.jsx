...
export default function BookingModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6 bg-espresso/90 backdrop-blur-xl animate-in fade-in">
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-3 glass-panel p-3.5 rounded-2xl border border-white/10">
                ...
                <div>
                  ...
                  >
                    <option value="10:00 AM" className="bg-charcoal">10:00 AM - 11:00 AM</option>
                    <option value="02:00 PM" className="bg-charcoal">02:00 PM - 03:00 PM</option>
                    <option value="07:00 PM" className="bg-charcoal">07:00 PM - 08:00 PM</option>
                    <option value="09:30 PM" className="bg-charcoal">09:30 PM - 10:30 PM</option>
                  </select>
                </div>
              </div>
              ...
              <div className="pt-4 border-t border-white/10 flex items-center justify-between">
                ...
                <button
                  ...
                  className="btn-primary px-6 py-2.5 rounded-xl text-xs font-bold text-white flex items-center gap-2 shadow-terracotta"
                >
            ...
            <div className="space-y-5">
              ...
              <div className="glass-panel p-4 rounded-2xl border border-white/10 space-y-2">
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="px-4 py-2 rounded-xl text-xs font-bold bg-gold-500/20 text-gold-300 border border-gold-500/40 hover:bg-gold-500/30"
                  >
                    Apply
                  </button>
                </div>
              ...
              <div className="glass-panel p-4 rounded-2xl border border-white/10 text-xs space-y-2">
                ...
                <div className="pt-2 border-t border-white/10 flex justify-between text-base font-extrabold text-white">
                  ...
                  <span className="text-gold-400">{formatPrice(finalTotal)}</span>
                </div>
              </div>
            ...
            <div className="space-y-6 text-center">
              ...
              <div className="flex flex-col items-center">
                ...
                <p className="text-xs text-slate-400 mt-0.5">
                  Reference: <span className="font-mono text-gold-400 font-bold">{confirmedBooking.booking_ref}</span>
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-2">
                ...
                <button
                  onClick={onClose}
                  className="flex-1 btn-primary py-2.5 px-4 rounded-xl text-xs font-bold text-white shadow-terracotta"
                >
                  Done & Close
                </button>
              </div>
