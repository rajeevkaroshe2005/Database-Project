...
export default function HeroSection({ onSelectService, onSearchSubmit, onExploreCatalog, services = [] }) {
  return (
    <div className="relative pt-24 pb-16 lg:pt-32 lg:pb-24 overflow-hidden bg-gradient-to-b from-white via-[#FAF8F3] to-[#F5F1E8]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-6 space-y-6 text-center lg:text-left z-10">
            {/* Super Badge */}
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white border border-sand-300/80 backdrop-blur-md text-xs font-semibold text-terracotta shadow-sm">
              <Sparkles className="w-3.5 h-3.5 text-gold-400" />
              <span>The Premier Unified Reservation System</span>
            </div>

            {/* Editorial Heading */}
            <h1 className="text-4xl sm:text-6xl font-black tracking-tight text-espresso leading-[1.08] font-serif">
              BOOK YOUR NEXT{' '}
              <span className="italic font-serif text-transparent bg-clip-text bg-gradient-to-r from-terracotta via-amber-700 to-gold-600">
                EXPERIENCE
              </span>
            </h1>

            {/* Subheading */}
            <p className="text-base sm:text-lg text-charcoal/80 max-w-xl mx-auto lg:mx-0 leading-relaxed font-sans">
            ...
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-4 pt-2 text-xs text-charcoal/70">
